# A tiny intro to exploring Bayesian statistics


# What proportion p of the earth's surface is water?
...
# Dbinom will give us the probability of seeing W waters for any hypothesized p
dbinom(water, size = total_toss, prob = 0.5)

# Let's create a range of hypothetical ps and see what r says:
...
# Let's call sampling A our "preliminary data" aka our prior
...
p_grid$new_likelihoods <- dbinom(water2, size = total_toss2, prob = p_grid$ps)
...
# inspect your q0 and q1. Is the prior p or p_new a better fit for the data?
q0
q1
